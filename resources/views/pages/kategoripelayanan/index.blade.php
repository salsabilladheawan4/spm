...
<div class="card w-100">
  <div class="card-body p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('kategoripelayanan.create') }}" class="btn btn-primary">
      ...
      <table class="table table-striped text-nowrap mb-0 align-middle" id="table-kategori">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('kategoripelayanan.edit', $item->kategori_id) }}" class="btn btn-warning btn-sm">
                <i class="ti ti-pencil"></i>
              </a>
              <form action="{{ route('kategoripelayanan.destroy', $item->kategori_id) }}" method="POST" class="d-inline">
                @csrf
                @method('DELETE')
