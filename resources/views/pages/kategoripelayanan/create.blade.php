...
@section('title', 'Tambah Kategori Pelayanan')

@section('content')
<div class="card">
  <div class="card-body">
    <h5 class="card-title fw-semibold mb-4">Tambah Kategori Pelayanan Baru</h5>
    ...
    <form action="{{ route('kategoripelayanan.store') }}" method="POST">
        @csrf
        <div class="mb-3">
            <label class="form-label">Nama Kategori</label>
            <input type="text" name="nama" class="form-control" placeholder="Contoh: Administrasi KTP" required>
        </div>
        <div class="mb-3">
